...
void add_trains()
{
    ...
    FILE *fp=fopen("E:\\C_Project\\Railway Reservation System\\traindetails.dat","rb");
    if(fp==NULL)
    {
        fp=fopen("E:\\C_Project\\Railway Reservation System\\traindetails.dat","wb");
...
{
    FILE *fp=fopen("E:\\C_Project\\Railway Reservation System\\allbookings.dat","rb");
    if(fp==NULL)
        return 0;
    Passenger pr;
...
int book_ticket(Passenger p)
{
    ...
    FILE *fp;
    fp=fopen("E:\\C_Project\\Railway Reservation System\\allbookings.dat","ab");   //ab is used so to append the next ticket no.
    if(fp==NULL)
    {
        textcolor(LIGHTRED);
        gotoxy(1,20);
...
{
    FILE *fp;
    fp=fopen("E:\\C_Project\\Railway Reservation System\\allbookings.dat","rb");
    if(fp==NULL)
    {
        textcolor(LIGHTRED);
        gotoxy(1,20);
...
{
    FILE *fp1;
    fp1=fopen("E:\\C_Project\\Railway Reservation System\\allbookings.dat","rb");
    if(fp1==NULL)
    {
        textcolor(LIGHTRED);
        gotoxy(1,20);
    ...
    FILE *fp2;
    fp2=fopen("E:\\C_Project\\Railway Reservation System\\temp.dat","wb");
    Passenger pr;
    int found=0;
    ...
    if(found==0)
    {
        remove("E:\\C_Project\\Railway Reservation System\\temp.dat");      //if ticket is not found,then delete the 'temp.dat' file.
    }
    else
    {
        remove("E:\\C_Project\\Railway Reservation System\\allbookings.dat");
        rename("E:\\C_Project\\Railway Reservation System\\temp.dat","E:\\C_Project\\Railway Reservation System\\allbookings.dat");     //if found,then rename 'temp.dat' to 'allbookings.dat' and check for cancelticket.
    }
    return found;
}
...
{
    int result;
    FILE *fp1=fopen("E:\\C_Project\\Railway Reservation System\\allbookings.dat","rb");
    if(fp1==NULL)
    {
        textcolor(LIGHTRED);
        gotoxy(1,20);
    ...
    FILE *fp2=fopen("E:\\C_Project\\Railway Reservation System\\temp.dat","wb");
    Passenger pr;
    int found=0;
    while(fread(&pr,sizeof(pr),1,fp1)==1)
    {
    ...
    if(found==0)
    {
        remove("E:\\C_Project\\Railway Reservation System\\temp.dat");
    }
    else
    {
        result=remove("E:\\C_Project\\Railway Reservation System\\allbookings.dat");
        if(result!=0)
            return 2;
        result=rename("E:\\C_Project\\Railway Reservation System\\temp.dat","E:\\C_Project\\Railway Reservation System\\allbookings.dat.dat");
        if(result!=0)
            return 2;
